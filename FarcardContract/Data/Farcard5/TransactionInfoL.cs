...
namespace FarcardContract.Data.Farcard5
{
    ...
    public class TransactionInfoL
    {
        private readonly UInt16 _size = 104;
        public UInt16 Sieze
        {
            get { return 0; }
            set { }
        ...
        ///  номер чека
        /// </summary>
        [Description("номер чека A")]
        public UInt16 RKCheckA
        {
            get { return _wRkCheck; }
            set { _wRkCheck = value; }
        }

        private UInt16 _wRkCheck;
